...
public class MainQuestionAdapter extends ArrayAdapter<QuestionList> {       //메인화면에서 문제리스트 어댑터
    int groupid;
    ArrayList<QuestionList> records;
    Context context;

    public MainQuestionAdapter(Context context, int vg, ArrayList<QuestionList> records) {
