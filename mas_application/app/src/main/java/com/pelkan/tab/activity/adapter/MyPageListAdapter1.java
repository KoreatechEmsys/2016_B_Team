...
public class MyPageListAdapter1 extends ArrayAdapter<String> {
    ...
    public MyPageListAdapter1(Context context, int vg, ArrayList<String> records) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            convertView = inflater.inflate(R.layout.hahaha, null);
