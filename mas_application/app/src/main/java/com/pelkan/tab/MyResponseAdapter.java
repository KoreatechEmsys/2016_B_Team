...
public class MyResponseAdapter extends ArrayAdapter<QuestionList> {       //메인화면에서 문제리스트 어댑터
    int groupid;
    ArrayList<QuestionList> records;
    Context context;

    public MyResponseAdapter(Context context, int vg, ArrayList<QuestionList> records) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            convertView = inflater.inflate(R.layout.my_response, null);
