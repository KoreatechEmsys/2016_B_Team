...
public class ModifyFragment extends Fragment {
    ...
    private String url_create_product = "http://218.150.182.58:2041/mas/modify_content.php";
    ...
    static ModifyFragment newInstance(int SectionNumber){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (getArguments() != null) {                       //클릭한 pid 저장
            ...
            title.setText(getArguments().getString("title").toString());
            content.setText(getArguments().getString("content").toString());
            temp_img_url = getArguments().getString("img_url");
            aq.id(myimage).image(temp_img_url);
        }
...
*/
    ...
    private void launchUploadActivity(boolean isImage, int requestCode){
        ...
        startActivity(i);
        aq.id(myimage).image(setting.getString("img_url", ""));
    }
...
/*
    ...
    private class LongOperation  extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... urls) {//클릭이벤트 실행시 파라미터값 urls= LongOperation().execute(serverURL);
            ...
            String img_url = temp_img_url;
            String is_img = setting.getString("is_add_img_true", "");
            if (!(is_img.equals("1")))
                return null;
            else {
                img_url = setting.getString("img_url", "");
            }
            if(all_keyword.equals(""))
                return null;
